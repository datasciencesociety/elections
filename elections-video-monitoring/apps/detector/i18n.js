const TRANSLATIONS = {
  ...
  bg: {
    ...
    'unavailable':       'Видеото е недостъпно',
    'ended':             '🚨 Видеото ЗАВЪРШИ',
    'ended.beyond':      'Заявено t={t}с е след края на потока (продължителност: {dur}с)',
    'ended.normal':      'Видеото завърши на {dur}с',
    'ended.unknown':     'Видеото завърши на ?',
    'log.ready':         'Детекторът за замразяване е готов',
    'log.started':       'Стартиране на видео: {url}',
    'log.loaded':        'Видеото е зареден — наблюдението е активно',
    'log.stopped':       'Наблюдението е спряно от потребителя',
    'log.stalled':       'Видеото е прекъснато',
    'log.retry':         'Повторен опит след {delay}с… ({n}/{max})',
    'log.maxretry':      'Достигнат максимален брой опити — спряно',
    'log.no.url':        'Моля въведете URL на видео',
    ...
    'notif.frozen':      '🚨 Видеото е замразен',
